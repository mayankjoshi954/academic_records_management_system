...
{ 
    return (!preg_match( "^([_a-zA-Z0-9-]+)(\.[_a-zA-Z0-9-]+)*@gbpuat-tech.ac.in^", $str)) ? FALSE : TRUE; 
} 
...
{  
    ...
    if(!email_validation($_POST['email'])) { 
        $msg="Email must have domain @gbpuat-tech.ac.in";
    } 
            ...
            <form action="#" method="post" id="fileForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" required type="text" name="email" id="email"
                        placeholder="Valid domain name: @gbpuat-tech.ac.in" />
                ...
                <br>
                <h4>Instead, signup as an <span><a href="signup_alumni.php">Alumni</a></span>.</h4>
            </form>
        </div>
    </div>
