...
{
    $sql = "SELECT user.name as author,user.category,user.department,title,YEAR(date_published) as Year,weblink,description from publication INNER JOIN user ON user.user_id = publication.user_id";
    // Prepare the query:
...
$results=$query->fetchAll(PDO::FETCH_OBJ);
      ...
      $sql = "SELECT user.name as author,user.category,user.department,title,YEAR(date_published) as Year,weblink,description from publication INNER JOIN user ON user.user_id = publication.user_id where user.category=".':category'." and user.department=".':department'." and YEAR(date_published)=".':year';
//Prepare the query:
$query = $con->prepare($sql);
