  ...
  if($email != "" && $password != "") {
    try {
      ...
      {   // checks if the user actually exists(true/false returned)
          ...
          {
            $msg = "Not Registered or Invalid data";
          }
      }
      else
      {
      ...
      <form action="login.php" method="post" id="fileForm" role="form">
        ...
        <div class="form-group">
          ...
          <input class="form-control" required type="text" name="email" id="email"
            placeholder="domain name: @gbpuat-tech.ac.in" onchange="email_validate(this.value);" />
        ...
        <div class="form-group">
          ...
          <br><br><span class="loginMsg"><?php echo @$msg;?></span>
        </div>
